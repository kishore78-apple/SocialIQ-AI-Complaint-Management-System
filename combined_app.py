...
with st.sidebar:
    ...
    st.write("1. Complaint Reason")
    st.write("2. Department")
    st.write("3. Sentiment")
    st.write("4. Feedback Category")
    st.write("5. Priority")
    st.write("6. Emergency")
    st.write("7. Harmful Content")
    st.write("8. Trend Forecasting")
    st.write("9. Anomaly Detection")
    st.write("10. Government Action")
...
if page == "🏠 Dashboard":
    ...
    high_priority_count = (
        int((df["Priority"].astype(str).str.lower() == "high").sum())
    ...
    if predict:
        ...
        if not citizen_name.strip():
            ...
            try:
                ...
                st.info("Expected backend URL: http://127.0.0.1:8000")
...
# =====================================================
    ...
    st.success(
        ...
        The complaint passes through ten intelligent modules covering
